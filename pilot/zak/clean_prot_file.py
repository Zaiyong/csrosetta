...
to_add_resonances=[]
for resonance in resonance_list.itervalues():
	if resonance_list.sequence()[resonance.resid()-1]=='V' and resonance.name()=='QG':
		resonance.atom().set_name('QG1')
		to_add_resonances.append(Resonance(-1,Atom('QG2',resonance.resid()),resonance.freq(),resonance.error()))
for res in to_add_resonances:
	resonance_list.add_resonance(res)
